...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 70, 180, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 555, 390, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 855, 430, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 110, 70, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 520, 200, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 855, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 340, 380, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 860, 80, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 170, 30, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 865, 495, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 570, 80, 30, 15, 1),
  ],
  ...
  enemigos: [
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 3, {
      desdeX: 0,
      hastaX: 0,
      desdeY: -110,
      hastaY: 610,
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 325, 90, 30, 6, {
      desdeX: -100,
      hastaX: 970,
      desdeY: 0,
      hastaY: 577,
    }, 'h'),
    new ZombieCaminante('imagenes/zombie3.png', 430, 155, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie1.png', 490, 490, 10, 10, 1.5, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie2.png', 870, 490, 10, 10, 0.5, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie1.png', 860, 280, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577,
    }),
    new ZombieCaminante('imagenes/zombie3.png', 170, 90, 10, 10, 1, {
      desdeX: 0,
      hastaX: 960,
      desdeY: 0,
      hastaY: 580,
